...
export const baseURL = "https://newapi.akataxi.uz/";

const requestWithoutApi = axios.create({
  baseURL,
  timeout: 100000,
...
requestWithoutApi.interceptors.response.use((response) => response.data, errorHandler);

export default requestWithoutApi;
