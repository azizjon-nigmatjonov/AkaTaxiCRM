        ...
        <>
            <div className='flex items-start justify-between'>
                <div >
                    ...
                    <p className='text-[var(--gray)] text-sm'>Haydovchini so’rovini rad etish uchun unga sababni bildiring</p>
                </div>
            ...
            <div className='w-full  my-9'>
                <HFTextareaAutosize name='ignore' control={control} placeholder='Sababni yozing' />
            </div>
