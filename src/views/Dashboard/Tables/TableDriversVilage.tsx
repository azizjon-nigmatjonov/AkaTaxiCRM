...
function TableDriversVilage({
  setCountWeekDriversVilage,
  setSelectMonthDriversVilage,
  setYearDriversVilage,
  driverTripsDataFromVilage,
}: {
  setCountWeekDriversVilage: any;
  setSelectMonthDriversVilage: any;
  setYearDriversVilage: any;
  ...
  const handleWeekChange = (event: any) => {
    ...
    setCountWeekDriversVilage(selectedWeekValue);
  };
  ...
  useEffect(() => {
    setYearDriversVilage(currentYear);
  }, [currentYear]);
  ...
  useEffect(() => {
    setSelectMonthDriversVilage(currentMonth);
  }, [currentMonth])
