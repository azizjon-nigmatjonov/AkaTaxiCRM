...
function Drivers({ data, isLoading }: DriversProps) {
  ...
  return (
    <div
      className={`max-w-[50%] p-6 w-full rounded-[12px] bg-white border border-[var(--gray20)] card-shadow`}
    >
      ...
      <div className="flex gap-[49px]">
        ...
        <div className="mt-6">
          ...
          <p className="text-3xl text-[#054F31] font-semibold mt-2">
            {data?.active}
          </p>
